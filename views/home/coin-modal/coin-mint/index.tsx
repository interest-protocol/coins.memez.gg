...
import CoinMintButton from './coin-mint-button';
import CoinMintPreview from './coin-mint-preview';
...
const CoinMint: FC = () => {
  ...
  return (
    <FormProvider {...form}>
      ...
      >
        <Div gap="1rem" height="100%" display="flex" flexDirection="column">
          <Div
            display="flex"
            alignItems="center"
            justifyContent="space-between"
